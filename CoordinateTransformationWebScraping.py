...
import urllib2 
import numpy as num 
a= input('What is your orginal coordinate system\n1.Equatorial\n2.Galactic\n3.Ec liptic\n4.Supergalactic\n\n***Enter the corresponding number.eg for Galactic ple ase enter 2*********\n') 
if a==1: 
	in_csys='Equatorial' 
elif a==2: 
	in_csys='Galactic' 
...
c=raw_input("Enter the path of the .dat file where your orginal data with longit ude, latitude and position angle in three different column is.eg /home/manu/Desk top/in.dat\n") 

file1=num.loadtxt(c) 
d=raw_input("Enter full path where you want to save the file. eg. /home/manu/Des ktop/out.dat\n") 
...
for i in range(n): 
	values={'in_csys':in_csys,'in_equinox':in_equinox,'obs_epoch':'1950.0',' lon':str(file1[i][0])+'d','lat':str(file1[i][1])+'d','pa':str(file1[i][2]),'out_ csys':out_csys,'out_equinox':out_equinox} 
...
# print a file2.write('%f\t%f\t%f\n'%(float(a[0]),float(a[1]),float(a[2]))) file2.close()
